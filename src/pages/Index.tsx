        ...
        <div className="container mx-auto max-w-6xl">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-muted-foreground mb-8 max-w-3xl mx-auto">
              Die Plattform für Handwerker und Auftraggeber in Österreich. Schnell, zuverlässig und transparent.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            ...
            >
              <div className="flex items-center justify-center gap-2 mb-2">
                ...
                <span className="text-3xl font-bold text-primary">{stats?.avgRating || 4.9}</span>
              </div>
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto max-w-6xl">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground">In nur 3 einfachen Schritten zum perfekten Handwerker</p>
          </motion.div>
        ...
        <section className="py-20 px-4">
          <div className="container mx-auto max-w-6xl">
            ...
            >
              ...
              <p className="text-xl text-muted-foreground">Unsere verifizierten Profis mit den besten Bewertungen</p>
            </motion.div>
      ...
      <section className="py-20 px-4 bg-gradient-to-r from-primary to-secondary text-primary-foreground">
        <div className="container mx-auto max-w-4xl text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <h2 className="text-4xl font-bold mb-6">Starten Sie jetzt Ihr nächstes Projekt</h2>
            <p className="text-xl mb-8 opacity-90">Kostenlos, unverbindlich und in nur 2 Minuten</p>
            <Button
              size="lg"
              onClick={() => navigate("/kunde/projekt-erstellen")}
